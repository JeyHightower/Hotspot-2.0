...
router.post('/:reviewId/images', requireAuth, validateReviewImage, asyncHandler(async (req, res, next) => {
    const user = req.user;
    let reviewId;
    try {
...
router.put('/:reviewId', requireAuth, validateReviewEdit, asyncHandler(async (req, res, next) => {
    const user = req.user;
