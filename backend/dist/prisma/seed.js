...
const addImagesForSpot = (spotId, urls) => __awaiter(void 0, void 0, void 0, function* () {
    for (const [index, url] of urls.entries()) {
        yield prisma.spotImage.create({
            data: {
                spotId,
                url,
                preview: index === 0,
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let evil = yield prisma.user.upsert({
        ...
        const spots = [
            ...
            },
            {
                ...
                description: "Stunning beachfront villa with direct beach access, private pool, and panoramic ocean views. Modern luxury meets coastal charm.",
                price: 1299.99,
                images: [
                    "https://images.unsplash.com/photo-1613490493576-7fde63acd811",
                    "https://images.unsplash.com/photo-1573052905904-34ad8c27f0cc",
        ...
        const newSpots = [
            {
                ...
                description: "Stunning cliffside villa with panoramic ocean views, private beach access, and infinity pool. Modern luxury meets California coastal living.",
                price: 1499.99,
                images: [
                    "https://images.unsplash.com/photo-1512917774080-9991f1c4c750",
                    "https://images.unsplash.com/photo-1523217582562-09d0def993a6",
                ...
                review: "Absolutely breathtaking! The views and amenities exceeded all expectations.",
                stars: 5,
            },
            {
                ...
                description: "Luxurious penthouse overlooking Central Park. Features wraparound terrace, private elevator, and floor-to-ceiling windows.",
                price: 2999.99,
                images: [
                    "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267",
                    "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688",
        ...
        for (const spotData of spots) {
            const { images, review, stars } = spotData, spotInfo = __rest(spotData, ["images", "review", "stars"]);
            // Create or update spot
            const spot = yield prisma.spot.upsert({
                where: {
                ...
                update: spotInfo,
                create: Object.assign(Object.assign({}, spotInfo), { ownerId: 1 }),
            });
            // Delete existing images for this spot
            yield prisma.spotImage.deleteMany({
                where: { spotId: spot.id },
            });
            // Add new images
            yield addImagesForSpot(spot.id, images);
